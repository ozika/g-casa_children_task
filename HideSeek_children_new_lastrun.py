...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\45040\\Desktop\\MCNB\\Career\\MPI\\psychopy_task_new\\HideSeek_children_new_lastrun.py',
...
sounds_1 = sound.Sound(Audio_intr, secs=-1, stereo=True, hamming=True,
    name='sounds_1')
...
key_resp_3.rt = []
_key_resp_3_allKeys = []
sound_stop.setSound('A', secs=1.0, hamming=True)
